...
pub const BUILD: &str = "r39-geometric-icons";
...
#[tauri::command]
fn get_codex_accounts() -> Vec<codex::CodexAccount> {
    codex::get_accounts()
}
...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .setup(move |app| {
            ...
            if args.iter().any(|a| a == "--accounts") { open_codex_accounts(handle.clone()); }
            if args.iter().any(|a| a == "--settings") { open_settings(handle.clone()); }
